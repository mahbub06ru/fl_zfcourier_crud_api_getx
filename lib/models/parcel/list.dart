...
//
//     final parcelListModel = parcelListModelFromJson(jsonString);

import 'dart:convert';

ParcelListModel parcelListModelFromJson(String str) => ParcelListModel.fromJson(json.decode(str));

String parcelListModelToJson(ParcelListModel data) => json.encode(data.toJson());

class ParcelListModel {
  final List<Parcel>? content;
  final int? totalElements;
  final int? page;
  final int? size;
  final ParcelSummary? summary;
  ...
  factory ParcelListModel.fromJson(Map<String, dynamic> json) => ParcelListModel(
    content: json["content"] == null ? [] : List<Parcel>.from(json["content"]!.map((x) => Parcel.fromJson(x))),
    totalElements: json["totalElements"],
    page: json["page"],
    size: json["size"],
    summary: json["summary"] == null ? null : ParcelSummary.fromJson(json["summary"]),
  );
